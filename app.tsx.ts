...
export default function FinMoneyApp() {
  // Navigation state
  ...
  useEffect(() => {
    const newParticles = Array.from({ length: 50 }, (_, i) => ({
      ...
      color: ['from-cyan-400', 'from-purple-400', 'from-pink-400', 'from-blue-400'][Math.floor(Math.random() * 4)],
  ...
  useEffect(() => {
    const savedExpenses = localStorage.getItem('finmoney_expenses');
    if (savedExpenses) {
  ...
  useEffect(() => {
    localStorage.setItem('finmoney_expenses', JSON.stringify(expenses));
  }, [expenses]);
  ...
  return (
    <div className="min-h-screen bg-gray-900 relative overflow-hidden">
      ...
      {/* Header */}
      <header className="relative z-10 bg-gray-800/80 backdrop-blur-md text-white shadow-xl border-b border-gray-700">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <div className="bg-gradient-to-br from-cyan-400 to-blue-500 p-1 rounded-full animate-pulse">
      ...
      <main className="container mx-auto px-4 py-8 relative z-10">
        ...
        {activePage === 'dashboard' && (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {/* Total Expenses Card */}
              <div className="bg-gray-800/70 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-gray-700 transform transition-transform duration-300 hover:scale-105">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
              {/* Recent Expenses */}
              <div className="bg-gray-800/70 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-gray-700">
                <div className="bg-gradient-to-r from-gray-800 to-gray-900 text-white p-4 border-b border-gray-700">
                  ...
                  {expenses.length === 0 ? (
                    ...
                    <div className="space-y-3 max-h-80 overflow-y-auto pr-2">
                      {[...expenses].reverse().slice(0, 5).map(expense => (
                        <div key={expense.id} className="flex justify-between items-center border-b border-gray-700 pb-3">
                          <div>
                          ...
                          <span className="font-medium text-cyan-400">${expense.amount.toFixed(2)}</span>
                        </div>
                      ))}
                    </div>
                  )}
                ...
                <div className="p-4">
                  {monthsToGoal === null ? (
                    <div className="text-center py-6">
                      ...
                      <button 
                        onClick={() => setActivePage('savings')}
                        className="mt-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white py-2 px-4 rounded-md text-sm hover:from-purple-700 hover:to-pink-700 transition-all"
                      >
        ...
        {activePage === 'expenses' && (
          <section className="bg-gray-800/70 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-gray-700 transform transition-all duration-500">
            ...
            <div className="p-6">
              <div className="flex flex-wrap gap-4 mb-6">
                <div>
                  ...
                  <select 
                    ...
                    className="bg-gray-900 text-gray-200 border border-gray-700 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500"
                  >
              ...
              <form onSubmit={handleAddExpense} className="mb-6 bg-gray-900/50 p-4 rounded-xl border border-gray-700">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-gray-900 text-gray-200 border border-gray-700 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-cyan-500"
              ...
              <div className="mb-6 p-4 bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl border border-gray-700">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-2xl font-bold text-cyan-400">${totalExpenses.toFixed(2)}</span>
                </div>
              </div>
                ...
                {filteredExpenses.length === 0 ? (
                  ...
                  <div className="space-y-3 max-h-96 overflow-y-auto pr-2">
                    {filteredExpenses.map(expense => (
                      <div 
                        key={expense.id} 
                        className="flex justify-between items-center border-b border-gray-700 pb-3 bg-gray-900/50 p-3 rounded-lg hover:bg-gray-900/70 transition-all duration-300"
                      >
                        <div>
                          <p className="font-medium text-white">{expense.description}</p>
                          <p className="text-sm text-gray-500">
        ...
        {activePage === 'savings' && (
          <section className="bg-gray-800/70 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-gray-700 transform transition-all duration-500">
            ...
            <div className="p-6">
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-900 text-gray-200 border border-gray-700 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-purple-500"
                    placeholder="10000"
                    min="0"
                    step="0.01"
                  />
              ...
              {monthsToGoal !== null && (
                <div className="mt-8 p-6 bg-gradient-to-r from-gray-800 to-gray-900 rounded-xl border border-gray-700 animate-fadeIn">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="relative pt-1">
                        <div className="flex mb-2 items-center justify-between">
                          <div>
                            <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-purple-300 bg-gray-900">
                              Progress
                            </span>
                          </div>
                        ...
                        <div className="overflow-hidden h-3 mb-4 text-xs flex rounded-full bg-gray-700">
                          <div 
                            style={{ width: `${Math.min(100, (currentSavings / goalAmount) * 100)}%` }} 
                            className="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-gradient-to-r from-purple-500 to-pink-500 rounded-full transition-all duration-1000 ease-out"
                          ></div>
                        </div>
                      </div>
              ...
              <div className="mt-8">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start bg-gray-900/50 p-3 rounded-lg border border-gray-700 hover:border-purple-500 transition-all duration-300">
          ...
          <section className="bg-gray-800/70 backdrop-blur-sm rounded-2xl shadow-2xl overflow-hidden border border-gray-700 transform transition-all duration-500">
            ...
            <div className="p-6">
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-900 text-gray-200 border border-gray-700 rounded-md px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500"
                    placeholder="5000"
                    min="0"
                    step="0.01"
                  />
                ...
                <button 
                  ...
                  className={`w-full flex items-center justify-center font-medium py-3 px-4 rounded-md transition-all duration-300 ${
                    isCalculatingTaxes 
                      ...
                      : 'bg-gradient-to-r from-green-600 to-teal-600 hover:from-green-700 hover:to-teal-700 text-white shadow-lg hover:shadow-xl transform hover:-translate-y-0.5'
                  }`}
                >
                  {isCalculatingTaxes ? (
                    <>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-700">
                        ...
                        <p className="text-xl font-bold text-green-400">${estimatedTaxes.annualIncome.toLocaleString()}</p>
                      </div>
                      <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-700">
                        <p className="text-sm text-gray-400">Monthly Taxes</p>
                        <p className="text-xl font-bold text-green-400">${estimatedTaxes.monthlyTaxes.toFixed(2)}</p>
                      </div>
                    </div>
                    ...
                    <div className="bg-gray-900/50 p-4 rounded-lg border border-gray-700">
                      ...
                      <div className="flex justify-between mt-3 pt-3 border-t border-gray-700">
                        ...
                        <span className="font-bold text-green-400">${estimatedTaxes.totalTaxes.toFixed(2)}</span>
                      </div>
                    </div>
              ...
              <div className="mt-8">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start bg-gray-900/50 p-3 rounded-lg border border-gray-700 hover:border-green-500 transition-all duration-300">
                    <div className="flex-shrink-0 mt-1">
      ...
      <footer className="relative z-10 bg-gray-900 border-t border-gray-800 text-white py-8 mt-12">
        <div className="container mx-auto px-4 text-center">
          <p className="text-lg">© {new Date().getFullYear()} FinMoney. All rights reserved.</p>
